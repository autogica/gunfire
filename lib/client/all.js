...
// see https://github.com/mrdoob/three.js/blob/master/examples/js/SimulationRenderer.js
...
function SimulationRenderer(WIDTH, renderer) {
	...
	var velocityShader = new THREE.ShaderMaterial({
		...
		uniforms: {
			...
			texturePosition: { type: "t", value: null },
			textureVelocity: { type: "t", value: null },
			testing: { type: "f", value: 1 },
			seperationDistance: { type: "f", value: 1 },
			alignmentDistance: { type: "f", value: 1 },
			cohesionDistance: { type: "f", value: 1 },
			freedomFactor: { type: "f", value: 1 },
