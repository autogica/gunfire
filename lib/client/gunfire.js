...
window.ObjectPoolFactory = (function() {
  ...
  ObjectPoolFactory.prototype.compile = function(rebuildGeometry, rebuildMaterial, rebuildMesh) {
    var i, len, mesh, obj, _i, _j, _len, _ref, _ref1, _ref2, _ref3, _ref4;
    if (rebuildGeometry) {
    ...
    if (rebuildMaterial) {
      ...
      if ((_ref1 = this.material) != null) {
        if (typeof _ref1.dispose === "function") {
          _ref1.dispose();
        }
      }
      if ((_ref2 = this.texture) != null) {
    ...
    if (this.objects.length >= this.size) {
      ...
      for (i = _j = len, _ref4 = this.size; len <= _ref4 ? _j < _ref4 : _j > _ref4; i = len <= _ref4 ? ++_j : --_j) {
