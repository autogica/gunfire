(function() {
  "use strict";
  var Primus, PrimusCluster, PrimusEmitter, PrimusMultiplex, PrimusRedis, PrimusRedisRooms, PrimusResource, PrimusRooms, app, babelCore, colors, config, crypto, fs, getRedisClient, http, importModule, open, path, primus, redis, resolvePath, server, simplewalk, syncAsset, uncachedRequire, updateAssets, util, utils, watch,
    slice = [].slice;
  ...
  updateAssets = function(files) {
    var Module, Wrapped, clientCodeES5, clientCodeES6, dirName, err, fileName, fullPath, head, i, j, jsonStr, len, meta, mod, modules, ref, ref1, ref2, ref3, ref4, ref5, ref6, results, serverCodeES5, serverCodeES6, src;
    if (files == null) {
      files = [];
    }
    if (!app.updateNeeded) {
    ...
    if (!files.length) {
      files = simplewalk.match(config.assetsDir, /(\.(?:json|js|es6|coffee|ts))$/gi) || [];
    }
    modules = {};
      ...
      switch (fileName) {
        case 'client.es6':
          ...
          try {
            ...
            if ((clientCodeES6 != null) && clientCodeES6 !== '') {
              ...
              mod.data.client = (ref1 = clientCodeES5.code) != null ? ref1 : clientCodeES5;
              mod.data.clientSourceMap = (ref2 = clientCodeES5.map) != null ? ref2 : [];
        ...
        case 'server.es6':
          try {
            ...
            if ((serverCodeES6 != null) && serverCodeES6 !== '') {
              ...
              src = "function(Module){\n  " + ((ref3 = serverCodeES5.code) != null ? ref3 : serverCodeES5) + "\n  return Server;\n}";
              console.log(src);
              Wrapped = eval(src);
              Module = {};
              mod.data.server = Wrapped(Module);
              mod.data.serverSourceMap = (ref4 = serverCodeES5.map) != null ? ref4 : [];
            } else {
              mod.error = 'bad server';
            }
          } catch (_error) {
        ...
        case 'package.json':
          try {
            ...
            mod.data.name = ("" + ((ref5 = meta.name) != null ? ref5 : dirName)).trim().toLowerCase();
            mod.data.version = (ref6 = meta.version) != null ? ref6 : '0.0.0';
